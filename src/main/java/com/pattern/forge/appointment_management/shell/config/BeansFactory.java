package com.pattern.forge.appointment_management.shell.config;
...
import com.pattern.forge.appointment_management.core.domain.AppointmentServiceImpl;
import com.pattern.forge.appointment_management.shell.adapter.out.persistence.AppointmentPostgresRepo;
